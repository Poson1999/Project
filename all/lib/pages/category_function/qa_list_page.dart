...
class _QAListState extends State<QAList> {
  ...
  void getQAList() async {
    ...
    var url = "https://project-ccu-2021.000webhostapp.com/phpformobile/getQAList.php";
    var data = {
  ...
  void getAllQAList() async {
    ...
    var url = "https://project-ccu-2021.000webhostapp.com/phpformobile/getAllQAList.php";
  ...
  void deleteQA(String qaId) async {
    var url = "https://project-ccu-2021.000webhostapp.com/phpformobile/deleteQA.php";
    var data = {
      "id": qaId
    };
  ...
  void answerQA(String qaId, String answer) async {
    ...
    var url = "https://project-ccu-2021.000webhostapp.com/phpformobile/answerQA.php";
    var data = {
      "id": qaId,
  ...
  Widget build(BuildContext context) {
            ...
            itemBuilder: (context, index){
              return ListTile(
                leading: CircleAvatar(
                  // 已回答為綠色
                  backgroundColor: QAList[index].answererId != "" ? Colors.green : Colors.grey,
                  foregroundColor: Colors.white,
                  child: Text((index + 1).toString()),
                ),
                title: Text(QAList[index].question, maxLines: 1),
                subtitle: Text(QAList[index].answer, maxLines: 1, overflow: TextOverflow.ellipsis),
                trailing: IconButton(
                ...
                onTap: () async {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => QuestionPage(question: QAList[index])));
                },
              );
      ...
      Padding(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index){
            return ListTile(
              leading: CircleAvatar(
                backgroundColor: AllQAList[index].answererId != "" ? Colors.green : Colors.grey,
                foregroundColor: Colors.white,
                child: Text((index + 1).toString()),
              ),
              title: Text(AllQAList[index].question, maxLines: 1),
              subtitle: Text(AllQAList[index].answer, maxLines: 1, overflow: TextOverflow.ellipsis),
              trailing: IconButton(
                ...
                onPressed: () async {
                  ...
                  if(prefs.getString('UserIdCode') != "0"){
                    Fluttertoast.showToast(
                        msg: "Only the administrator can reply the question."
                    );
                  } else {
              ...
              onTap: () async {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => QuestionPage(question: AllQAList[index])));
              } ,
            );
          }, separatorBuilder: (BuildContext context, int index) => const Divider(),
        )
    ...
    const _tabs = <Tab>[
      Tab(icon: Icon(Icons.login), text: 'Post by me'),
      Tab(icon: Icon(Icons.upcoming), text: 'World Forum')
    ];
