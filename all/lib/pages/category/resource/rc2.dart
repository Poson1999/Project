...
class RC2 extends StatelessWidget {
  const RC2({Key? key}) : super(key: key);
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
              ...
              children: [
                ...
                const Padding(
                  padding: EdgeInsets.symmetric(vertical: 5),
                  child:SelectableText(rc_5, style: textStyle, textAlign: TextAlign.center),
                ),
                Padding(
                  padding: const EdgeInsets.symmetric(vertical: 5),
                  child: YoutubePlayerControllerProvider(
                    controller: YoutubePlayerController(
                        initialVideoId: rc2Linkid3,
                        params: const YoutubePlayerParams(
                            showControls: true
                        )
                    ),
